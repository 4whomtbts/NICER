...
<%
 ...
 if(loginId==null){
  ...
  request.setAttribute("top", "/Manhattan.html");
...
<html lang="en">
	...
	<script langugage='javascript'>
		function on_submit(){
			...
			var frm = document.manh;
			frm.action = 'Manhattan';
	...
	<body>
		...
		<section class="ftco-cover" style="background-image: url(images/genes_650x400_61470411347.jpg); max-width:auto; max-height:auto;" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row align-items-center ftco-vh-75">
					<div class="col-md-7">
						<h1 class="ftco-heading mb-3" data-aos="fade-up" data-aos-delay="500">Manhattan</h1>
            					<h2 class="h5 ftco-subheading mb-5" data-aos="fade-up"  data-aos-delay="600"> <a href="http://genetics.cs.ucla.edu/multiTrans/" target="_blank">Manhattan</a> is drawing tool.</h2>    
	          			</div>
				</div>
      		</div>
		</section>
		...
		<div class="container">
			<div class="col-md-7">
				<h1 data-aos="fade-up" data-aos-delay="500">Upload files to use Manhattan</h1> <!--  class="ftco-heading mb-3"  -->
        			<h2 data-aos="fade-up"  data-aos-delay="600">For analysis using Manhattan, you need to upload P-value file</h2>    <!-- class="h5 ftco-subheading mb-5" -->
			</div>
					...
					<div class="container">
						<div class="row block-9">
							<div class="col-md-6 pr-md-5">
								<form name='manh' action="Manhattan" method="post" enctype="multipart/form-data">
            								...
            								<div class="form-group">
              								<table  cellspacing="100%">
              									<tr>
              										...
              										<th><input type="file" name="P_file"></th>
              									</tr>
              								</table>
            								</div>
											<div class="form-group">
