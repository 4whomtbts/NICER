...
<html lang="en">
	<head>
		...
		function on_submit(){
			var gsWin = window.open('about:blank', 'payviewer', 'width=1200, height=400');
	...
	<body>
		...
		<section class="ftco-cover" style="background-image: url(images/genes_650x400_61470411347.jpg); max-width:auto; max-height:auto;" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row align-items-center ftco-vh-75">
					<div class="col-md-7">
						<h1 class="ftco-heading mb-3" data-aos="fade-up" data-aos-delay="500">eQTL</h1>
            					<h2 class="h5 ftco-subheading mb-5" data-aos="fade-up"  data-aos-delay="600"> <a href="http://genetics.cs.ucla.edu/multiTrans/" target="_blank">eQTL</a> is a cis/trans plot for GWAS</h2>    
	          			</div>
				</div>
      		</div>
		</section>
		...
		<div class="container">
			<div class="col-md-7">
				<h1 data-aos="fade-up" data-aos-delay="500">Upload files to use eQTL</h1> <!--  class="ftco-heading mb-3"  -->
        			<h2 data-aos="fade-up"  data-aos-delay="600">For analysis using eQTL, you need to upload SNP_position file, phenotype_position file and p-value file.</h2>    <!-- class="h5 ftco-subheading mb-5" -->
			</div>
					...
					<div class="container">
						<div class="row block-9">
							<div class="col-md-6 pr-md-5">
								<form name="eeqq" action="eQTL" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<input type="email" class="form-control" name="emailAddress" placeholder="The email address to receive the results.">
              								<table  cellspacing="100%">
              									<tr>
              										<th cellspacing="50%"><input type="text" placeholder=" Upload SNP_pos file" disabled></th>
              								...
              								<table  cellspacing="100%">
              									<tr>
              										<th cellspacing="50%"><input type="text" placeholder=" Upload Phenotype_pos file" disabled></th>
              										<th><input type="file" name="Phenotype_pos"></th>
              									</tr>
              								</table>
              								<table  cellspacing="100%">
              									<tr>
              										<th cellspacing="50%"><input type="text" placeholder=" Upload P-Value file" disabled></th>
								...
								<input type="button" name="upload" value="Submit" class="btn btn-primary py-3 px-5" onclick='on_submit()'>			
						</div>
				<div class="col-md-6" style="background-image: url(images/word_cloud.png); width:560px; height:448px;"> </div>
