...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div class="col-md-7">
				<h1 data-aos="fade-up" data-aos-delay="500">Upload files to use MultiTrans</h1> <!--  class="ftco-heading mb-3"  -->
        			<h2 data-aos="fade-up"  data-aos-delay="600">For analysis using MultiTrans, you need to upload SNP file, phenotype file and input the number of SNPs.</h2>    <!-- class="h5 ftco-subheading mb-5" -->
			</div>
					...
					<div class="container">
						<div class="row block-9">
							<div class="col-md-6 pr-md-5">
								<form action="MultiTransServlet" method="post" enctype="multipart/form-data">
