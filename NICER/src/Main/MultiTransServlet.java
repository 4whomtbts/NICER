...
public class MultiTransServlet extends HttpServlet {
	private static final String MULTITRANS_PWD = "/DGU-NICER/MultiTrans";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//	change the path later
				...
				a_1 = Runtime.getRuntime().exec("python3 " + MULTITRANS_PWD + "/Pylmm_MultiTrans/pylmmKinship.py -v --emmaSNP="+ file.getPath() +" --emmaNumSNPs="+ NumSNPs + " " + userDirString +"/K.txt");
